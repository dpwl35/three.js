...
const leftWallVector = new THREE.Vector3(1, 0, 0); //Raycaster가 충돌한 면의 법선벡터
...
export const MyRoomSkillPlaceMode = ({ currentPlacingMyRoomSkill }) => {
  ...
  useEffect(() => {
    ...
    const handlePointerMove = (e) => {
      const { clientX, clientY } = e; //현재 마우스 좌표
      ...
      let roomTouched = false; //방안 배치를 위한 것
      let xOffset = 0;
      let yOffset = 0;
      let zOffset = 0;
      ...
      // 현재 rayCaster에 잡힌 첫번째 오브젝트의 법선벡터와 3축의 벡터가 평행하다면
      // 각 축에 맞는 offset을 더해준다.
