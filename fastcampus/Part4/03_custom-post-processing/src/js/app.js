...
import vertexShader from "../shders/vertex.glsl";
import fragmentShader from "../shders/fragment.glsl";
...
export default function () {
  ...
  //three.js의 renderer 객체를 인자로 받아 렌더
  ...
  const addPostEffects = () => {
    ...
    effectComposer.addPass(renderPass); //렌더 정보 등록

    const filmPass = new FilmPass(1, 1, 2000, true);
